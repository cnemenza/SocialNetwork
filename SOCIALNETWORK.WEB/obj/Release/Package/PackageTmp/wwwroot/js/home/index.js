    ...
    var events = {
        onEventDetails: function () {
            $("#home-content").on("click", ".m-nav_details", function () {
                var id = $(this).data("id");
                window.location.href = `/evento/${id}/detalle`;
            })
        },
        onEventReport: function () {
            $("#home-content").on("click", ".m-nav_report", function () {
            ...
            $.ajax({
                ...
                .done(function (data) {
                    ...
                    $.each(data, function (i, v) {
                        newHtml += `  <div class="m-portlet m-portlet--brand m-portlet--head-solid-bg">
